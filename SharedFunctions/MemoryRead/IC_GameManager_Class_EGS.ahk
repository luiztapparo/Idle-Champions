...
class IC_GameManagerEGS_Class
{
    ...
    Refresh()
    {
        ...
        this.Game.GameInstance.Controller.Formation.FormationList.HeroAlive := New GameObjectStructure(this.Game.GameInstance.Controller.Formation.FormationList,, [0x249])
